...
?>
                <li>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="stretched-link attorney-link" href="<?php echo get_author_posts_url( $attorney->ID ); ?>"><span class="attorney-name"><?php echo $info->first_name . ' ' . $info->last_name; ?></span><br>
